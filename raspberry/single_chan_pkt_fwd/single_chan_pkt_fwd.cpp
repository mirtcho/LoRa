...
//mma from tx_demo->port lora.cpp 
...
//mma ported two function from tx_demo
void LoRa_idle()
{
...
void SetupLoRa()
{
  ...
  WriteRegister(REG_SYNC_WORD, 0x34); // mma enable this line. disabled only for test. LoRaWAN public sync word
  ...
  if (sx1272) {
    ...
    WriteRegister(REG_MODEM_CONFIG, 0x72); // BW=125KHz, Coding 4/5, Explicite header mode
...
int main()
{
  ...
  LoRa_setTxPower(17,PA_OUTPUT_RFO_PIN+1);//mma: pa_boost_pin use 7
